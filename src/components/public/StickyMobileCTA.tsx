...
export default function StickyMobileCTA() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-border p-3 grid grid-cols-2 gap-3 md:hidden shadow-[0_-4px_12px_rgba(0,0,0,0.05)] pb-safe">
      <a
        href={`tel:${phoneNumber}`}
        className="flex items-center justify-center gap-2 py-2.5 bg-ink text-white text-xs font-bold uppercase tracking-wider rounded-sm shadow-sm active:scale-95 transition-transform"
      >
